...
RUN apt-get update && apt-get install -y locales apache2 apache2-mpm-prefork libapache2-mod-php5 \
	php5 php-apc php5-cli php5-common php5-curl php5-gd php5-pgsql php5-imagick \
